                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={handleChange}
                                    placeholder="e.g. 94778973708 (or leave blank to use Contact Phone)"
                                />
                                <p className="text-xs text-muted-foreground">Enter number with country code (e.g. 94778973708). If left blank, WhatsApp chat will automatically use your Contact Phone above.</p>
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-foreground/80">WhatsApp Pre-filled Message</label>
                                <Input
                                    name="whatsappMessage"
                                    value={settings.whatsappMessage || ''}
                                    onChange={handleChange}
                                    placeholder="e.g. Hi, I would like to inquire about your products!"
                                />
                                <p className="text-xs text-muted-foreground">The initial greeting text that automatically fills in when a customer clicks the WhatsApp chat button.</p>
                            </div>
                        </div>
                    </Card>
